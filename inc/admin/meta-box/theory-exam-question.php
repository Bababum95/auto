...
class TheoryExamQuestion {
    ...
    private function enqueue_styles() {
        ...
        if (isset($manifest_data['src/admin/meta-box/theory-exam-question.scss'])) {
            $css_file = $manifest_data['src/admin/meta-box/theory-exam-question.scss']['file'];
            wp_enqueue_style('metabox-styles', get_template_directory_uri() . '/dist/' . $css_file);
        }

        if(isset($manifest_data['src/admin/meta-box/theory-exam-question.ts'])) {
            $js_file = $manifest_data['src/admin/meta-box/theory-exam-question.ts']['file'];
            wp_enqueue_script('metabox-script', get_template_directory_uri() . '/dist/' . $js_file, array('wp-i18n'), null, true);
        }
    }
